...
"Nhà nước là sản phẩm và biểu hiện của những mâu thuẫn giai cấp không thể điều hòa được."`;
    ...
    // === MOCK LỖI API ĐỂ TEST FALLBACK QWEN ===
    // Tạm thời tắt gọi Gemini thật:
    /*
    ...
    */
    ...
    // Cố tình ép lỗi 429 để kích hoạt Qwen fallback trên web:
    res.status(429).json({ error: 'MOCK ERROR: Cố tình giả lập lỗi 429 Too Many Requests để test Qwen Fallback' });
    return;
    // ===========================================
